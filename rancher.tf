...
resource "aws_lb" "rancher-alb" {
  ...
  subnets = ["subnet-0beea70633210965d", "subnet-08be6fb6a1a25c024", "subnet-0377e306a1c9edbf0"]
...
resource "null_resource" "privatekey" {
  ...
  provisioner "local-exec" {
    command = "terraform output -raw private > /Users/andrewreichek/Downloads/${var.mykey}.pem"
  }
    provisioner "local-exec" {
      command = "chmod 400 /Users/andrewreichek/Downloads/${var.mykey}.pem"
    }
}